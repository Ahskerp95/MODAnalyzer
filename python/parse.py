                        ...
                        for keyword in some_hists.keys():
                            ...
                            for mod_hist in some_hists[keyword]:
                                ...
                                for condition_keyword, condition_boundaries in conditions:
                                    ...
                                    print condition_keyword, numbers[keyword_index]
                                ...
                                if condition_satisfied:
                                    ...
                                    # print "i am here"
                                    # print keyword,
                                    # keywords_index_dictionary[keyword]
                                    x = float(
...
def parse_to_root_files(output_directory, data_file):
    ...
    # parse_to_root_file(input_filename=pythia_file, output_filename=(output_directory + "pythia.root",
    #                                                                 output_directory + "pythia_log.root"), hist_templates=(hist_templates,
    #                                                                                                                        log_hist_templates))

    # parse_to_root_file(input_filename=herwig_file, output_filename=(output_directory + "herwig.root",
    #                                                                 output_directory + "herwig_log.root"), hist_templates=(hist_templates,
    #                                                                                                                        log_hist_templates))

    # parse_to_root_file(input_filename=sherpa_file, output_filename=(output_directory + "sherpa.root",
    #                                                                 output_directory + "sherpa_log.root"), hist_templates=(hist_templates,
    #                                                                                                                        log_hist_templates))
